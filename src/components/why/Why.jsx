...
const whyConfig = {
  ...
  texts: [
    ...
    'We welcome the experts in MACH and those who would like to get a new trending skill. See below how you can <a target="_blank" href="https://kb.epam.com/display/EPMCMACH/MACH+Learning+Path">learn and practice</a> the technologies.',
  ],
};
